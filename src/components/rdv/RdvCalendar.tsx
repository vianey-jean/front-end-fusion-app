    ...
    if (draggedRdv) {
      ...
      try {
        ...
        if (conflicts.length > 0) {
          ...
          const nextAvailableTime = `${nextAvailableHour.toString().padStart(2, '0')}:${nextAvailableMin.toString().padStart(2, '0')}`;
          ...
          const newAvailableEndTime = `${newAvailableEndHour.toString().padStart(2, '0')}:${newAvailableEndMin.toString().padStart(2, '0')}`;
