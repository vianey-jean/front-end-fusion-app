...
import { Check, Truck, Package, ShoppingBag, Trash2 } from 'lucide-react';
...
import { ordersAPI, refundsAPI, Refund } from '@/services/api';
...
const OrdersPage = () => {
  ...
  const getRefundForOrder = (orderId: string) => {
    return refunds.find(refund => refund.orderId === orderId);
  };
                  ...
                  <CardContent>
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                      ...
                      <div className="flex gap-3">
                        {/* Bouton Supprimer - seulement si status confirmée */}
                          ...
                          <AlertDialog>
                            ...
                            <AlertDialogContent className="max-w-md">
                              ...
                              <AlertDialogFooter>
                                ...
                                >
                                  {processingOrder === order.id ? 'Suppression...' : 'Confirmer'}
                                </AlertDialogAction>
                              </AlertDialogFooter>
                            </AlertDialogContent>
                          </AlertDialog>
                        ...
                        {/* Bouton Remboursement - seulement si pas confirmée et pas de demande existante */}
                        {canRequestRefund(order) && !refund && (
                          <RefundButton 
                            orderId={order.id}
                        ...
                        {/* Bouton Suivie remboursement - si demande existante */}
                        {refund && (
                          <RefundTracking refund={refund} />
                        )}
