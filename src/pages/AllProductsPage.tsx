...
import { ShoppingBag, ChevronLeft, ChevronRight, TrendingUp, Sparkles, Star, Filter } from 'lucide-react';
    ...
    <Layout>
      <div className="min-h-screen bg-gradient-to-br from-neutral-50 via-white to-indigo-50/30 dark:from-neutral-950 dark:via-neutral-900 dark:to-indigo-950/30">
        ...
        <motion.div 
          ...
          className="relative overflow-hidden bg-gradient-to-r from-indigo-600 via-blue-600 to-purple-600 text-white py-20"
        >
          ...
          <div className="relative container mx-auto px-4 text-center">
            ...
            <motion.div
              ...
              className="flex items-center justify-center gap-4 text-sm text-blue-200"
            >
                    ...
                    >
                      ...
                      <div className="flex gap-2">
                        ...
                        {currentPage < totalPages && (
                          <Button
                            onClick={() => setCurrentPage(currentPage + 1)}
                            className="flex items-center gap-2 bg-gradient-to-r from-indigo-600 to-blue-600 hover:from-indigo-700 hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300"
                          >
                            Suivant
